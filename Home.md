...
- If you downloaded the ".exe" version of beatoraja (available from 0.8.1 onwards), you may have issues applying the [Locale Fix](#locale-fix) later. You can still apply the Locale fix, but you need to download the [beatoraja-config.bat](https://github.com/wcko87/beatoraja-english-guide/tree/resources/beatoraja-configs) file separately and place it in your beatoraja folder.
