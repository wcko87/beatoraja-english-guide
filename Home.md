...
This is for Windows only. For Mac/Linux, you can follow [these instructions](#setting-up-beatoraja-with-java), while using a portable version of Java instead.
