...
After loading a difficulty table into your BMS player (e.g. beatoraja), you will be able to see the list of songs in-game. However, you will still need to download the songs/charts to play them. 
